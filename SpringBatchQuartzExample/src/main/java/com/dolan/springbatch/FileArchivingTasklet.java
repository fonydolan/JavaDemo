...
public class FileArchivingTasklet implements Tasklet {
	...
	static final String ARCHIVE_DIRECTORY_PATH="D:/archivedFiles";
	
	private File archiveDirectory;

	public void init(){
		archiveDirectory = new File(ARCHIVE_DIRECTORY_PATH);
	}
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		map = chunkContext.getStepContext().getJobParameters();
